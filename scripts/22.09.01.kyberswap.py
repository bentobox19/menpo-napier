...
from stix2 import (AttackPattern, Identity, Indicator, Note,
    Relationship, Report, ThreatActor)
...
with open('../stix-db/22.09.01.kyberswap.json', 'w') as f:
